...
Public Class Build_client
    ...
    Private Sub AFunction()
        ...
        While True
            ...
            Me.folder_Building = String.Concat(str, "Building-6.4")
            Me.folder_apktool = String.Concat(str, "Building-6.4\apktool")
            Try
    ...
    Private Sub Build_client_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        Try
            ...
            Else
                ...
                Me.title("Build Client", Nothing)
                Dim streamReader As System.IO.StreamReader = New System.IO.StreamReader(String.Concat(Me.Resources, "\ClientSettings.inf"))
                Me.str = File.ReadAllLines(String.Concat(Me.Resources, "\ClientSettings.inf"))
...
Label0:
    ...
    Private Sub step3()
        If (Me.xx) Then
            NewLateBinding.LateCall(NewLateBinding.LateGet(Me.cmd_0, Nothing, "StandardInput", New Object(-1) {}, Nothing, Nothing, Nothing), Nothing, "WriteLine", New Object() {"Decompile.bat"}, Nothing, Nothing, Nothing, True)
            Me.prog(15)
    ...
    Private Sub step4()
        If (Me.xx) Then
            NewLateBinding.LateCall(NewLateBinding.LateGet(Me.cmd_0, Nothing, "StandardInput", New Object(-1) {}, Nothing, Nothing, Nothing), Nothing, "WriteLine", New Object() {"Compile.bat"}, Nothing, Nothing, Nothing, True)
            Me.step5()
            Me.prog(70)
        End If
    End Sub
