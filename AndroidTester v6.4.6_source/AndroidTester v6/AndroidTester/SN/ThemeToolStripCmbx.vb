...
Namespace SN
    Public Class ThemeToolStripCmbx
        ...
        Public Sub New()
            ...
            Me.selected_Color_ForColor = Color.FromArgb(214, 214, 214)
            Me.backColor = Color.FromArgb(27, 27, 28)
            Me.backColorStrip = Color.FromArgb(45, 45, 48)
            Me.ForColor = Color.FromArgb(174, 174, 174)
        ...
        Protected Overrides Sub OnRenderItemCheck(ByVal e As ToolStripItemImageRenderEventArgs)
            Try
                ...
                Dim linearGradientBrush As System.Drawing.Drawing2D.LinearGradientBrush = New System.Drawing.Drawing2D.LinearGradientBrush(rectangle, Me.backColorChecked1, Me.backColorChecked0, LinearGradientMode.Vertical)
                e.Graphics.FillRectangle(linearGradientBrush, rectangle)
                Me.DrawRoundedRectangle(e.Graphics, rectangle.Left, rectangle.Top, rectangle.Width, rectangle.Height, 1, Me.clrSelectedBorderCheck)
        ...
        Protected Overrides Sub OnRenderMenuItemBackground(ByVal e As ToolStripItemRenderEventArgs)
            Try
                    ...
                    If (TypeOf e.ToolStrip Is MenuStrip) Then
                        ...
                        Else
                            If (e.Item.Enabled) Then
                                Dim rectangle As System.Drawing.Rectangle = New System.Drawing.Rectangle(1, 1, e.Item.Width - 1, e.Item.Height - 1)
                                Dim linearGradientBrush As System.Drawing.Drawing2D.LinearGradientBrush = New System.Drawing.Drawing2D.LinearGradientBrush(rectangle, Me.selected_Color, Me.selected_Color, LinearGradientMode.Vertical)
                                e.Graphics.FillRectangle(linearGradientBrush, rectangle)
                                Me.DrawRoundedRectangle(e.Graphics, rectangle.Left, rectangle.Top, rectangle.Width - 1, rectangle.Height - 1, 1, Me.clrSelectedBorder)
                            End If
                        End If
                    End If
                ...
                ElseIf (e.Item.Enabled) Then
                    Dim rectangle1 As System.Drawing.Rectangle = New System.Drawing.Rectangle(2, 2, e.Item.Width - 2, e.Item.Height - 5)
