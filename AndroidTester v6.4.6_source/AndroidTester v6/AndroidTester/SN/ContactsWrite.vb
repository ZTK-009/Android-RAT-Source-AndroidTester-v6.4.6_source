...
Public Class ContactsWrite
    ...
    Private Sub ContactsWrite_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        Me.aNumber.HTBTB.ContextMenuStrip = ContextTextView.ContextMenuContextTextView
