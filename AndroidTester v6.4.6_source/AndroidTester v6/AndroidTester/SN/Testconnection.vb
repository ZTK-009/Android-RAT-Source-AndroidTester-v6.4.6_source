...
Public Class Testconnection
    ...
    Private Sub TrackNumcont_ValueChanged_1() Handles TrackNumcont.ValueChanged
        Me.Label1.Text = String.Concat("Client (", Conversions.ToString(Me.TrackNumcont.Value), ")")
    End Sub

    Private Sub Tracktimed_ValueChanged_1() Handles Tracktimed.ValueChanged
        Me.Label2.Text = String.Concat("Timeout (", Conversions.ToString(Me.Tracktimed.Value), ") sec")
    End Sub
End Class