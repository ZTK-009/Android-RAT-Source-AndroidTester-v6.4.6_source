    ...
    Public Class VisualStudioVerticalScrollBar
        ...
        Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
            Try
                ...
                End Select
                If (Me.Llen <> -1) Then
                    Dim num1 As Integer = CLng(Math.Round(CDbl(Me._ThumbSize) / 2))
                    Dim num2 As Integer = CLng(Math.Round(CDbl((Me.Llen - Me._Minimum)) / CDbl((Me.Maximum - Me._Minimum)) * CDbl((Me.Shaft.Height - num1))))
