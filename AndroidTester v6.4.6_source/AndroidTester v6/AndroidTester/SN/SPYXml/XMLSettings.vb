...
Namespace SN.SPYXml
    Public Class XMLSettings
        ...
        Public Sub New()
            Me.PATHXML = Store.Resources(1) + "\Imports\Xml\Settings\AndroidTester.xml"
        ...
        Public Sub LoadXML()
            ...
            If flag Then
                ...
                xmlTextWriter.WriteStartElement("AndroidTester")
                Me.CreateNode(Conversions.ToString(0), "Port", "2020", xmlTextWriter)
