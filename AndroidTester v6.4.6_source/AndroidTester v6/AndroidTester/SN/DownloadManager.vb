        ...
        Try
            ...
            If (Me.TClient.FileSizeBytesDownloaded <= Me.TClient.TotalFileSize) Then
                If (Me.TClient.FileSizeBytesDownloaded > CLng(0)) Then
                    ...
                    Dim Hours As Int16 = num \ 3600
                    Dim Minutes As Int16 = (num Mod 3600) \ 60
                    Dim Seconds As Int16 = num Mod 60

                    If (Operators.CompareString(time, "0:0:0", False) <> 0) Then
                        Me.inda = True
                        Me.expectedtime.Text = String.Concat("Remanining Time (sec): ", num)
                        ...
                        Me.Iwillfinishwhen.Text = String.Concat("Expected Finish Time: ", now.ToString("h:mm:ss"))
