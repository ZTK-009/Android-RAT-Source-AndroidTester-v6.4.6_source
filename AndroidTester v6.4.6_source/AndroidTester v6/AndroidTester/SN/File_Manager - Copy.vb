        ...
        Try
            ...
            ElseIf (Operators.CompareString(value, Store.BFF(Store.buff, CLng(84)), False) = 0) Then
                ...
                For i As Integer = 0 To length1 Step 1
                    ...
                    If (strArrays2.Length = 3) Then
                        strArrays2 = {strArrays2(0), strArrays2(1), strArrays2(2), "10251/storage/emulated/0/DCIM/Camera", "1025101/01/2030 Fri", "1025101/01/2030 Fri"}
                    ElseIf (strArrays2.Length = 2) Then
                        strArrays2 = {"10358", "10251NA.jpg", "102514096", "10251/storage/emulated/0/DCIM/Camera", "1025101/01/2030 Fri", "1025101/01/2030 Fri"}
                        'ElseIf (strArrays2.Length <= 1) Then
                        '    strArrays2 = {strArrays2(0), "", "", "NA", "NA", "NA"}
                    Else
                        If (Operators.CompareString(strArrays2(0), "-1", False) <> 0 And Operators.CompareString(strArrays2(1), "-1", False) <> 0 And Operators.CompareString(strArrays2(2), "-1", False) <> 0) Then
                            ...
                            'Extension Check File or Folder
                            ...
                            If (flag) Then
                                value1 = CStr(BytesConverter(Conversions.ToLong(strArrays2(2))).GetValue(0))
                            End If

                            'Folder or not
                            Dim num1 As Integer = 0
                            num1 = If(Not extension.StartsWith("Folder Files"), imageList_0.Images.IndexOfKey(extension.ToUpper()), imageList_0.Images.IndexOfKey("Folder Files".ToUpper()))
                            If (num1 = -1) Then
                                num1 = imageList_0.Images.IndexOfKey("-1".ToUpper())
                            End If
                            ...
                            Me.ViewManager.Rows.Add(New Object() {IMG(DirectCast(imageList_0.Images(num1), Bitmap), extension), strArrays2(1), value1, extension, str1, str2})
                            If (flag) Then
                                ViewManager.Rows(ViewManager.Rows.Count - 1).Cells(2).Tag = Conversions.ToLong(strArrays2(2))
                            End If
